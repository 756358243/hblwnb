	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
                ...
                "lsImg": {
                	"regex": /^.*?\.(jpg|JPG|jpeg|JPEG|PNG|png)$/,
                	"alertText": "* 图片格式不正确，只支持jpg,png格式"
                },
				"lsImgJNF": {
                	"regex": /^.*?\.(jpg|JPG|jpeg|JPEG|PNG|png|gif|GIF)$/,
                	"alertText": "* 图片格式不正确，只支持jpg,png,gif格式"
                },
                "lsXML": {
                	"regex": /^.*?\.(xml|XML)$/,
                	"alertText": "* 请选择XML文件（后缀名.xml或.XML）"
                },
				"lsAttachments": {
                	"regex": /^.*?\.(doc|DOC|DOCX|docx|pdf|PDF|jpg|JPG|JPEG|jpeg|PNG|png|xls|XLS|XLSX|xlsx|PPT|ppt)$/,
                	"alertText": "* 附件格式不正确"
                },
				"lsBankAccount": {
                	"regex": /^\d{16,19}$|^\d{6}[- ]\d{10,13}$|^\d{4}[- ]\d{4}[- ]\d{4}[- ]\d{4,7}$/,
                	"alertText": "* 银行卡号不正确"
                },
                "money" :{
                	"regex":/^[\-]?([0-9]{1})([0-9]*)(.[0-9]{1,2})?$/,
                	"alertText": "* 请输入正确的货币，只允许小数点后2位"
                },
				"website" :{
