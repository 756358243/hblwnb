...
public interface HCNetSDK extends StdCallLibrary {
	...
	//C:\\Users\\VKL\\workspace\\ClientDemo\\dll\\HCNetSDK
	String path= "C:\\Users\\dll\\HCNetSDK";
	/*String classPath = CameraCapture.class.getResource("").toString().replaceFirst("file:/", "");
	String prePath = classPath.substring(0, classPath.indexOf("WEB-INF"));
	String path= prePath +"dll/HCNetSDK";*/
...
{
	String path= "C:\\Users\\dll\\PlayCtrl";
	/*String classPath = HCNetSDK.class.getResource("").toString().replaceFirst("file:/", "");
	String prePath = classPath.substring(0, classPath.indexOf("WEB-INF"));
	String path= prePath +"dll/PlayCtrl";*/
	
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(path,
            PlayCtrl.class);
